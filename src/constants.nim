...
## ======================
##
## Mathematical numerical named constants useful for different disciplines
## (math, physics, chemistry, biology, engineering, data science, IT, etc),
...
## - Rust:   No relevant collection of mathematical constants built-in.
...
const
  ...
  ## `Euler's Totient <https://en.wikipedia.org/wiki/Euler%27s_totient_function>`_
  ...
  ## `Hafner–Sarnak–McCurley <https://en.wikipedia.org/wiki/Hafner%E2%80%93Sarnak%E2%80%93McCurley_constant>`_
  ...
  brun* = 0.87058838                                            ## \
  ## `Brun's <https://en.wikipedia.org/wiki/Brun%27s_constant>`_
  ## `constant <https://oeis.org/A065421>`_
  catalan* = 0.91596559417721901505460351                       ## \
  ## `Catalan's <https://en.wikipedia.org/wiki/Catalan%27s_constant>`_
  ## `constant <https://oeis.org/A006752>`_
  viswanath* = 1.13198824                                       ## \
  ## `Viswanath's <https://en.wikipedia.org/wiki/Viswanath%27s_constant>`_
  ## `constant <https://oeis.org/A078416>`_
  apery* = 1.20205690315959428539973816                         ## \
  ## `Apery's <https://en.wikipedia.org/wiki/Ap%C3%A9ry%27s_constant>`_
  ...
  ## `Mill's <https://en.wikipedia.org/wiki/Mills%27_constant>`_
  ## `constant <https://oeis.org/A051021>`_
  plastic* = 1.32471795724474602596090885                       ## \
  ## `Plastic's <https://en.wikipedia.org/wiki/Plastic_constant>`_
  ## `constant <https://oeis.org/A060006>`_
  ramanujanSoldner* = 1.45136923488338105028396848              ## \
  ## `Ramanujan-Soldner <https://en.wikipedia.org/wiki/Ramanujan%E2%80%93Soldner_constant>`_
  ...
  porter* = 1.4670780794                                        ## \
  ## `Porter's <https://en.wikipedia.org/wiki/Porter%27s_constant>`_
  ## `constant <https://oeis.org/A086237>`_
  liebsSquareIce* = 1.5396007178                                ## \
  ## `Lieb's square ice  <https://en.wikipedia.org/wiki/Lieb%27s_square_ice_constant>`_
  ## `constant <https://oeis.org/A118273>`_
  erdosBorwein* = 1.60669515241529176378330152                  ## \
  ## `Erdos-Borwein <https://en.wikipedia.org/wiki/Erd%C5%91s%E2%80%93Borwein_constant>`_
  ## `constant <https://oeis.org/A065442>`_
  niven* = 1.70521114010536776428855145                         ## \
  ## `Niven's <https://en.wikipedia.org/wiki/Niven%27s_constant>`_
  ## `constant <https://oeis.org/A033150>`_
  universalParabolic* = 2.29558714939263807403429804            ## \
  ## `Universal Parabolic <https://en.wikipedia.org/wiki/Universal_parabolic_constant>`_
  ## `constant <https://oeis.org/A103710>`_
  feigenbaumReductionParameter* = 2.50290787509589282228390287  ## \
  ## `Feigenbaum's Reduction Parameter <https://en.wikipedia.org/wiki/Feigenbaum_constants#The_second_constant>`_
  ## `constant <https://oeis.org/A006891>`_
  sierpinski* = 2.58498175957925321706589358                    ## \
  ## `Sierpinski's <https://en.wikipedia.org/wiki/Sierpi%C5%84ski%27s_constant>`_
  ## `constant <https://oeis.org/A062089>`_
  khinchin* = 2.68545200106530644530971483                      ## \
  ## `Khinchin's <https://en.wikipedia.org/wiki/Khinchin%27s_constant>`_
  ## `constant <https://oeis.org/A002210>`_
  fransenRobinson* = 2.80777024202851936522150118               ## \
  ## `Fransen-Robinson <https://en.wikipedia.org/wiki/Frans%C3%A9n%E2%80%93Robinson_constant>`_
  ## `constant <https://oeis.org/A058655>`_
  levy* = 3.27582291872181115978768188                          ## \
  ## `Levy's <https://en.wikipedia.org/wiki/L%C3%A9vy%27s_constant>`_
  ## `constant <https://oeis.org/A086702>`_
  reciprocalFibonacci* = 3.35988566624317755317201130           ## \
  ## `Reciprocal Fibonacci <https://en.wikipedia.org/wiki/Reciprocal_Fibonacci_constant>`_
  ## `constant <https://oeis.org/A079586>`_
  feigenbaumBifurcationVelocity* = 4.66920160910299067185320382 ## \
  ## `Feigenbaum's Bifurcation Velocity <https://en.wikipedia.org/wiki/Feigenbaum_constants#The_first_constant>`_
  ...
  ## `Dottie <https://en.wikipedia.org/wiki/Dottie_number>`_
  ## `constant <https://oeis.org/A003957>`_
  weierstrass* = 0.47494937998792065033                         ## \
  ## `Weierstrass <https://en.wikipedia.org/wiki/Karl_Weierstrass#Mathematical_contributions>`_
  ...
  ## `Gelfond <https://en.wikipedia.org/wiki/Gelfond%27s_constant>`_
  ## `constant <https://oeis.org/A039661>`_
  lebesgue* = 1.43599112417691743235                            ## \
  ## `Lebesgue <https://en.wikipedia.org/wiki/Lebesgue_constant_(interpolation)>`_
  ## `constant <https://oeis.org/A226654>`_
  goldenAngle* = 2.39996322972865332223                         ## \
  ## `Golden Angle <https://en.wikipedia.org/wiki/Golden_angle>`_
  ...
  ## `Reuleaux Triangle <https://en.wikipedia.org/wiki/Reuleaux_triangle>`_
  ## `constant <https://oeis.org/A066666>`_
  spiralOfTheodorus* = 1.86002507922119030718                   ## \
  ## `Spiral Of Theodorus <https://en.wikipedia.org/wiki/Spiral_of_Theodorus>`_
  ...
  ## `Feller-Tornier <https://en.wikipedia.org/wiki/Feller%E2%80%93Tornier_constant>`_
  ## `constant <https://oeis.org/A065493>`_
  champernowne* = 0.12345678910111213141                        ## \
  ## `Champernowne <https://en.wikipedia.org/wiki/Champernowne_constant>`_
  ## `constant <https://oeis.org/A033307>`_
  gelfondSchneider* = 2.66514414269022518865                    ## \
  ## `Gelfond-Schneider <https://en.wikipedia.org/wiki/Gelfond%E2%80%93Schneider_constant>`_
  ## `constant <https://oeis.org/A007507>`_
  khinchinLevy* = 1.18656911041562545282                        ## \
  ## `Khinchin-Levy <https://en.wikipedia.org/wiki/Khinchin%E2%80%93L%C3%A9vy_constant>`_
  ## `constant <https://oeis.org/A100199>`_
  calabiTriangle* = 1.55138752454832039226                      ## \
  ## `Calabi Triangle <https://en.wikipedia.org/wiki/Calabi_triangle>`_
  ## `constant <https://oeis.org/A046095>`_
  eulerGompertz* = 0.59634736232319407434                       ## \
  ## `Euler-Gompertz <https://en.wikipedia.org/wiki/Gompertz_constant>`_
  ## `constant <https://oeis.org/A073003>`_
  vanDerPauw* = 4.53236014182719380962                          ## \
  ## `Van Der Pauw <https://en.wikipedia.org/wiki/Van_der_Pauw_method>`_
  ...
  ## `Loch's <https://en.wikipedia.org/wiki/Lochs%27_theorem>`_
  ## `constant <https://oeis.org/A086819>`_
  hyperbolicTangent* = 0.76159415595576488811                   ## \
  ## `Hyperbolic Tangent <https://en.wikipedia.org/wiki/Hyperbolic_function#Hyperbolic_tangent>`_
  ...
  ## `Robbins <https://en.wikipedia.org/wiki/Robbins_constant>`_
  ## `constant <https://oeis.org/A073012>`_
  connective* = 1.84775906502257351225                          ## \
  ## `Connective <https://en.wikipedia.org/wiki/Connective_constant>`_
  ...
  ## `Komornik-Loreti <https://en.wikipedia.org/wiki/Komornik%E2%80%93Loreti_constant>`_
  ...
  ## `Artin's conjecture on primitive roots <https://en.wikipedia.org/wiki/Artin%27s_conjecture_on_primitive_roots>`_
  ## `constant <https://oeis.org/A005596>`_
  mRB* = 0.18785964246206712024                                 ## \
  ## `MRB <https://en.wikipedia.org/wiki/MRB_constant>`_
  ...
  ## `Somos Quadratic Recurrence <https://en.wikipedia.org/wiki/Somos%27_quadratic_recurrence_constant>`_
  ...
  ## `Foias Alpha <https://en.wikipedia.org/wiki/Foias_constant>`_
  ## `constant <https://oeis.org/A085848>`_
  foiasBeta* = 2.29316628741186103150                           ## \
  ## `Foias Beta <https://en.wikipedia.org/wiki/Foias_constant>`_
  ...
  ## `Volume of Reuleaux Tetrahedron <https://en.wikipedia.org/wiki/Reuleaux_tetrahedron>`_
  ## `constant <https://oeis.org/A102888>`_
  raabe* = 0.91893853320467274178                               ## \
  ## `Raabe's <https://en.wikipedia.org/wiki/Gamma_function#Raabe's_formula>`_
  ...
  ## `Kepler-Bouwkamp <https://en.wikipedia.org/wiki/Kepler%E2%80%93Bouwkamp_constant>`_
  ## `constant <https://oeis.org/A085365>`_
  prouhetThueMorse* = 0.41245403364010759778                    ## \
  ## `Prouhet-Thue-Morse <https://en.wikipedia.org/wiki/Prouhet%E2%80%93Thue%E2%80%93Morse_constant>`_
  ## `constant <https://oeis.org/A014571>`_
  heathBrownMoroz* = 0.00131764115485317810                     ## \
  ## `Heath-Brown–Moroz <https://en.wikipedia.org/wiki/Heath-Brown%E2%80%93Moroz_constant>`_
  ...
  ## `Stephens <https://en.wikipedia.org/wiki/Euler_product#Notable_constants>`_
  ## `constant <https://oeis.org/A065478>`_
  taniguchi* = 0.67823449191739197803                           ## \
  ## `Taniguchi <https://en.wikipedia.org/wiki/Euler_product#Notable_constants>`_
  ...
  ## `Area of Ford Circle constant <https://en.wikipedia.org/wiki/Ford_circle>`_
  ...
  ## `Copeland–Erdos <https://en.wikipedia.org/wiki/Copeland%E2%80%93Erd%C5%91s_constant>`_
  ...
  ## `Magic Angle <https://en.wikipedia.org/wiki/Magic_angle>`_
  ## `constant <https://oeis.org/A195696>`_
  polya* = 0.34053732955099914282                               ## \
  ## `Polya <https://en.wikipedia.org/wiki/Random_walk>`_
  ## `constant <https://oeis.org/A086230>`_
  wright* = 1.9287800                                           ## \
  ## `Wright constant <https://oeis.org/A086238>`_
  chebyshev* = 0.59017029950804811302                           ## \
  ## `Chebyshev <https://en.wikipedia.org/wiki/Conformal_radius#The_Fekete.2C_Chebyshev_and_modified_Chebyshev_constants>`_
  ...
  ## `DeVicci's tesseract <https://en.wikipedia.org/wiki/Prince_Rupert%27s_cube#Generalizations>`_
  ## `constant <https://oeis.org/A243309>`_
  plouffeGamma* = 0.14758361765043327417                        ## \
  ## `Plouffe's Gamma (Bailey–Borwein–Plouffe) <https://en.wikipedia.org/wiki/Bailey%E2%80%93Borwein%E2%80%93Plouffe_formula#The_BBP_formula_for_%CF%80>`_
  ...
  ## `Glaisher–Kinkelin <https://en.wikipedia.org/wiki/Glaisher%E2%80%93Kinkelin_constant>`_
  ...
  gaussianGravitational* = 0.01720209895                        ## \
  ## `Gaussian Gravitational <https://en.wikipedia.org/wiki/Gaussian_gravitational_constant>`_
  speedOfLight* = 299792458                                     ## \
  ## `Speed of Light in vacuum <https://en.wikipedia.org/wiki/Speed_of_light>`_ ``m / (s)``
  gravitational* = 6.67408e-11                                  ## \
  ## `Gravitational constant <https://en.wikipedia.org/wiki/Constant_of_gravitation>`_ ``m3 / (kg s2)``
  gas* = 8.3144598                                              ## \
  ## `Gas constant <https://en.wikipedia.org/wiki/Gas_constant>`_ ``J / (K mol)``
  rydberg* = 10973731.6                                         ## \
  ## `Rydberg constant <https://en.wikipedia.org/wiki/Rydberg_constant>`_ ``1 / (m)``
  bohrRadius* = 5.29177211e-11                                  ## \
  ## `Bohr Radius constant <https://en.wikipedia.org/wiki/Bohr_radius>`_ ``m``
  fineStructure* = 0.00729735257                                ## \
  ## `Fine Structure constant <https://en.wikipedia.org/wiki/Fine-structure_constant>`_
  wienWavelengthDisplacementLaw* = 0.0028977729                 ## \
  ## `Wien wavelength displacement law <https://en.wikipedia.org/wiki/Wien%27s_displacement_law>`_ ``m K``
  electronCharge* = 1.60217662e-19                              ## \
  ## `Electron Charge (Elementary Charge) <https://en.wikipedia.org/wiki/Elementary_charge>`_ ``C``
  vacuumElectricPermittivity* = 8.85418782e-12                  ## \
  ## `Vacuum Electric Permittivity constant <https://en.wikipedia.org/wiki/Vacuum_permittivity>`_ ``F/m``
  accelerationOfGravity* = 9.80665                              ## \
  ## `Standard acceleration of gravity <https://en.wikipedia.org/wiki/Gravity>`_ ``m / s2``
  planck* = 6.62607004e-34                                      ## \
  ## `Planck constant <https://en.wikipedia.org/wiki/Planck_constant>`_ ``J s``
  reducedPlanck* = 1.0545718e-34                                ## \
  ## `Reduced Planck constant <https://en.wikipedia.org/wiki/Planck_constant>`_ ``J s``
  boltzmann* = 1.38064852e-23                                   ## \
  ## `Boltzmann constant <https://en.wikipedia.org/wiki/Boltzmann_constant>`_ ``J / (K)``
  electronMass* = 9.10938356e-31                                ## \
  ## `Electron mass constant <https://en.wikipedia.org/wiki/Electron>`_ ``kg``
  neutronMass* = 1.67492747e-27                                 ## \
  ## `Neutron mass constant <https://en.wikipedia.org/wiki/Atomic_mass_constant>`_ ``kg``
  protonMass* = 1.6726219e-27                                   ## \
  ## `Proton mass constant <https://en.wikipedia.org/wiki/Proton>`_ ``kg``
  magneticVacuumPermeability* = 1.25663706e-06                  ## \
  ## `Magnetic Vacuum Permeability constant <https://en.wikipedia.org/wiki/Magnetic_constant>`_ ``N/A2``
  bohrMagneton* = 9.27400999e-24                                ## \
  ## `Bohr magneton constant <https://en.wikipedia.org/wiki/Bohr_magneton>`_ ``J/T``
  thomsonScatteringCrossSection* = 6.65245872e-29               ## \
  ## `Thomson Scattering Cross-Section constant <https://en.wikipedia.org/wiki/Thomson_scattering>`_ ``m2``
  stefanBoltzmann* = 5.670367e-08                               ## \
  ## `Stefan-Boltzmann constant <https://en.wikipedia.org/wiki/Stefan%E2%80%93Boltzmann_constant>`_ ``W / (K4 m2)``
  atomicMass* = 1.66053904e-27                                  ## \
  ## `Atomic mass constant <https://en.wikipedia.org/wiki/Atomic_mass_constant>`_ ``kg``
  earthMass* = 3.986004e+14                                     ## \
  ## `Earth Mass constant (nominal) <https://en.wikipedia.org/wiki/Earth_mass>`_ ``m3 / (s2)``
  jupiterMass* = 1.2668653e+17                                  ## \
  ## `Jupiter Mass constant (nominal) <https://en.wikipedia.org/wiki/Jupiter_mass>`_ ``m3 / (s2)``
  sunMass* = 1.3271244e+20                                      ## \
  ## `Sun Mass constant (nominal) <https://en.wikipedia.org/wiki/Solar_mass>`_ ``m3 / (s2)``
  bolometricLuminosity* = 3.0128e+28                            ## \
  ## `Luminosity for absolute bolometric magnitude 0 constant <https://en.wikipedia.org/wiki/Bolometric_luminosity>`_ ``W``
  solarLuminosity* = 3.828e+26                                  ## \
  ## `Solar luminosity constant (nominal) <https://en.wikipedia.org/wiki/Solar_luminosity>`_ ``W``
  earthEquatorialRadius* = 6378100                              ## \
  ## `Earth equatorial radius constant <https://en.wikipedia.org/wiki/Earth_radius>`_ ``m``
  jupiterEquatorialRadius* = 71492000                           ## \
  ## `Jupiter equatorial radius constant <https://en.wikipedia.org/wiki/Jupiter_radius>`_ ``m``
  sunEquatorialRadius* = 695700000                              ## \
  ## `Sun equatorial radius constant <https://en.wikipedia.org/wiki/Sun>`_ ``m``
  astronomicalUnit* = 1.49597871e+11                            ## \
  ## `Astronomical Unit constant <https://en.wikipedia.org/wiki/Astronomical_unit>`_ ``m``
  kiloparsec* = 3.08567758e+19                                  ## \
  ## `Kiloparsec constant <https://en.wikipedia.org/wiki/Kiloparsec>`_ ``m``
  parsec* = 3.08567758e+16                                      ## \
  ## `Parsec constant <https://en.wikipedia.org/wiki/Parsec>`_ ``m``
  orbitalPeriodOfEarth* = 365.24219879                          ## \
  ## `Orbital period of Earth constant <https://en.wikipedia.org/wiki/Orbital_period>`_ ````
  earthsRotationalPeriod* = 23.96                               ## \
  ## `Earths rotational period constant <https://en.wikipedia.org/wiki/Earth%27s_rotation>`_ ````
  faraday* = 9.64870e4                                          ## \
  ## `Faraday constant <https://en.wikipedia.org/wiki/Faraday_constant>`_ ````
  josephson* = 483597.898e9                                     ## \
  ## `Josephson constant <https://en.wikipedia.org/wiki/Josephson_constant>`_ ````
